...
def main():
    ...
    ip_timer_thread = threading.Thread(target=show_timer, args=("Changing IP...", stop_event))
    ...
    print(f"\nIP changed successfully to 192.168.{router_number}.{random_ip}")
    ...
    dns_timer_thread = threading.Thread(target=show_timer, args=("Changing DNS...", stop_event))
